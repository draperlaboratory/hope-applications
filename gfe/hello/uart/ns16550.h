...
#ifdef FPGA_GFE
#define NS16550_CLOCK_RATE  (50000000ULL) //50MHz
#elif FPGA_DOVER
...
/**
   Initializes the uart.  The control registers on the uart will be written to
   configure the uart for these parameters.

   @param uart SOC address of the NS16550 control registers.
 */
